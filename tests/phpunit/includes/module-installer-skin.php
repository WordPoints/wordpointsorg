...
/**
 * WordPoints.org module installer skin class for use in the PHPUnit tests.
 *
...
/**
 * WordPoints.org module installer skin.
 *
 * @since 1.0.0
 */
class WordPointsOrg_Tests_Module_Installer_Skin extends WordPoints_Module_Installer_Skin {
