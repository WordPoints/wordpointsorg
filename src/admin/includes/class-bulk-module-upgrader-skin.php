...
class WordPointsOrg_Bulk_Module_Upgrader_Skin extends Bulk_Upgrader_Skin {
	...
	public function bulk_footer() {
		...
		$update_actions =  array(
			'modules_page' => '<a href="' . self_admin_url( 'admin.php?page=wordpoints_modules' ) . '" target="_parent">' . __( 'Return to Modules page', 'wordpoints' ) . '</a>',
			'updates_page' => '<a href="' . self_admin_url( 'update-core.php' ) . '" target="_parent">' . __( 'Return to WordPress Updates', 'wordpoints' ) . '</a>'
		);
